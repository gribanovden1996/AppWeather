...
class _$HourImpl with DiagnosticableTreeMixin implements _Hour {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Hour(timeEpoch: $timeEpoch, tempC: $tempC, chanceOfRain: $chanceOfRain, chanceOfSnow: $chanceOfSnow, uv: $uv, windKph: $windKph, pressureMb: $pressureMb)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, timeEpoch, tempC, chanceOfRain,
      chanceOfSnow, uv, windKph, pressureMb);
